...
const Home = () => {
  ...
  const strings = [
    ...
    ["मैं शानदार, बदलाव किये जाने योग्य वेब एप्लिकेशन बनाता हूं，", <br key={2}/>, "और बेहतर, अच्छी तरह से डिजाइन किये हुए कोड बनाता हूँ।"],
    ["Construyó escalante apps de web", <br key={3}/>, "y preparó códigos limpios é estructurales"],
    ["我创建优化的，可扩展的Web应用程序，", <br key={4}/>, "并提供干净，设计良好的代码"],
    ["퍼포멘트와 확장가능한 웹 앱와", <br key={5}/>,"간단한 설계코드 되어 있는 것을 전해 드립니다"],
  ];
